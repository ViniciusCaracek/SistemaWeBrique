                ...
                <section class="full-box nav-lateral">
                    ...
                    <div class="full-box nav-lateral-content">
                        ...
                        <nav class="full-box nav-lateral-menu">
                            <ul>
                                <li>
                                    <a href="<?php echo base_url('DashBoardHome/DashboardUser') ?>"><i class="fab fa-dashcube fa-fw"></i> &nbsp;
                                        Home</a>
                                </li>
                                ...
                                <li>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="<?php echo base_url('produto/listar_produto_user') ?>"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp;
                                                Lista de
                                                produtos</a>
                                        </li>
                                        <li>
                                            <a href="<?php echo base_url('produto/pesquisarProdutoUser') ?>"><i class="fas fa-search fa-fw"></i> &nbsp; Buscar
                                                produtos</a>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <li>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="<?php echo base_url('localizacao/listar_localizacao_user') ?>"><i class="fas fa-map"></i> &nbsp;
                                ...
                                <li>
                                    <a href="#" class="nav-btn-submenu"><i class="fas  fa-user fa-fw"></i> &nbsp;
                                        Usuário Cadastrado <i class="fas fa-chevron-down"></i></a>
                                    <ul>
                                        <li>
                                        ...
                                        <li>
                                            <a href="<?php echo base_url('Cadastro/listar_usuario_user') ?>"><i class="fas fa-id-badge"></i> &nbsp;
                                                Seu Usuário</a>
                                        </li>
                                ...
                                <li>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="<?php echo base_url('RedeSocial/listar_rede_social_user') ?>"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp;
                                                Lista de
                                                Redes Sociais</a>
                                        </li>
