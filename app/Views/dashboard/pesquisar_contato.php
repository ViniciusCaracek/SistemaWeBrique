<main>
    ...
    <section class="full-box page-content">
        ...
        <div class="full-box page-header">
            <div class="container">
                <div class="text-dashboard-home">
                    <h3 class="text-left">
                        <i class="fas fa-clipboard-list fa-fw"></i> &nbsp; Pesquisar Contatos
                    </h3>
                    <p class="text-justify">
                        Pesquisar contatos que estão cadastrados no sistema
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid">
            ...
            <a href="<?php echo base_url('contato') ?>"><button class="btn_top_tab" style="float:left;"> <i class="fas fa-arrow-left fa-fw"></i></button></a>
            <div class="botoes_top_tab">
                <a href="<?php echo base_url('contato') ?>"><button class="btn_top_tab">Cadastrar Novo <i class="fas fa-plus fa-fw"></i></button></a>
                <a href="<?php echo base_url('contato/pesquisarContato') ?>"><button class="btn_top_tab">Pesquisar Contato <i class="fas fa-search fa-fw"></i></button></a>
            </div>
...
<!--                            <div class="modal fade" id="modalDeletar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog " role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <a href="<?php echo base_url('../Sistema_TCC/public/index.php/contato/excluir') ?>"> <button type="button" data-target="#modalDeletar" class="btn btn-outline-danger btn-ok">Excluir <i class="fas fa-trash-alt trash_icon"></i></button></a>
