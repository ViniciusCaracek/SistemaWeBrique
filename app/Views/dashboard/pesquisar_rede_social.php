<main>
    ...
    <section class="full-box page-content">
        ...
        <div class="container-fluid">
            ...
            <a href="<?php echo base_url('RedeSocial/listar_rede_social') ?>"> <button class="btn_top_tab" style="float:left;"> <i class="fas fa-arrow-left fa-fw"></i></button></a>
            <div class="botoes_top_tab">
                ...
                <a href="<?php echo base_url('RedeSocial/pesquisarRedeSocial') ?>"><button class="btn_top_tab">Pesquisar Rede Social <i class="fas fa-search fa-fw"></i></button></a>
            </div>
                        ...
                        <?php foreach ($sociais as $social) : ?>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><a href="<?php echo base_url('../Sistema_TCC/public/index.php/RedeSocial/editar/' . $social->id_usuario) ?>" title="Editar"><button class="botao_tabela_editar"> <i class="fas fa-edit edit_icon"></i></button></a>
                                        <a href="<?php echo base_url('../Sistema_TCC/public/index.php/RedeSocial/excluir/' . $social->id_usuario) ?>" title="Excluir" data-toggle="" data-target="" onclick="return confirm('Tem certeza que deseja excluir esse registro?')" > <button class="botao_tabela_deletar"><i class="fas fa-trash-alt trash_icon"></i></button></a>
                                    </td>
                                </tr>
