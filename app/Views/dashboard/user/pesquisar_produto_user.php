<main>
    ...
    <section class="full-box page-content">
        ...
        <div class="full-box page-header">
            <div class="container">
                <div class="text-dashboard-home">
                    <h3 class="text-left">
                        <i class="fas fa-clipboard-list fa-fw"></i> &nbsp; Pesquisar Produtos
                    </h3>
                    <p class="text-justify">
                        Pesquisar produtos que estão cadastrados no sistema
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid">
            ...
            <a href="<?php echo base_url('produto') ?>"><button class="btn_top_tab" style="float:left;"> <i class="fas fa-arrow-left fa-fw"></i></button></a>
            <div class="botoes_top_tab">
                <a href="<?php echo base_url('produto') ?>"><button class="btn_top_tab">Cadastrar Novo <i class="fas fa-plus fa-fw"></i></button></a>
                <a href="<?php echo base_url('produto/pesquisarProdutoUser') ?>"><button class="btn_top_tab">Pesquisar Produto <i class="fas fa-search fa-fw"></i></button></a>
            </div>
