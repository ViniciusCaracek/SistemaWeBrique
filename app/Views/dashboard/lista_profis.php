        ...
        <nav class="full-box navbar-info">
                ...
                <div class="container">
                    <div class="text-dashboard-home">
                        ...
                        <p class="text-justify">
                            Lista que contém os dados armazenados dos profissionais artesãos, nela é mostrado o número
                            identificador, o nome, a descrição,
                            o telefone e a data de nascimento. o usuário com o nível de administrador poderá fazer a
                            alteração e exclusão do cadastro nesta lista.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="container-fluid">
                ...
                <a href="lista_profis.php"><button href="lista_profis.php" class="btn_top_tab" style="float:left;"> <i
                        class="fas fa-arrow-left fa-fw"></i></button></a>
                <div class="botoes_top_tab">
                   <a href="../cadastro.php"><button  class="btn_top_tab">Cadastrar Novo <i
                            class="fas fa-plus fa-fw"></i></button></a>
                    <a href="pesquisar_profis.php"><button  class="btn_top_tab">Pesquisar Artesão <i
